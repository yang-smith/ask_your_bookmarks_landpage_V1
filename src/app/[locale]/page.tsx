    ...
    <>
      ...
      <MaxWidthWrapper className="mt-10 flex flex-col items-center justify-center text-center sm:mt-12">
        ...
        <h1 className="max-w-5xl text-5xl font-bold md:text-6xl lg:text-7xl">
          <span className="text-blue-600">Simple</span> & <span className="text-blue-600">Smart</span>
          <br></br>
          Bookmark Manager
        </h1>
              ...
              <div className="flex flex-col gap-6 md:flex-row">
                <Card className="flex flex-col items-center justify-center gap-2 p-6 md:flex-1">
                  ...
                  <CardDescription className="mb-3 text-center">
                    Find bookmarks with just a vague memory of their content.
                  </CardDescription>
                  <Image
                    src="/logo.png"
                    alt="Smart Search"
                ...
                <Card className="flex flex-col items-center justify-center gap-2 p-6 md:flex-1">
                  ...
                  <CardDescription className="mb-3 text-center">
                    Adaptively learns your browsing habits for better bookmark suggestions.
                  </CardDescription>
                  <Image
                    src="/personal.png"
                ...
                <Card className="flex flex-col items-center justify-center gap-2 p-6 md:flex-1">
                  ...
                  <CardDescription className="mb-3 text-center">
                    AI-powered categorization and cleanup of dead links to keep your bookmarks tidy. (coming soon)
                  </CardDescription>
                  <Image
                    src="/schedule.webp"
